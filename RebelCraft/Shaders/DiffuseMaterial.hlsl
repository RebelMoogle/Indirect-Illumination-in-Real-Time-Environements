...
#ifndef DIFFUSE_MATERIAL_HLSL
#define DIFFUSE_MATERIAL_HLSL
...
// Vertex Shader
//--------------------------------------------------------------------------------------
GSPS_INPUT DiffuseMaterialVS( VS_INPUT input )
{
...
// Pixel Shader
//--------------------------------------------------------------------------------------
float4 DiffuseMaterialPS( GSPS_INPUT input) : SV_Target
{
